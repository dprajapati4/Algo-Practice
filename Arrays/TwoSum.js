/* Write a function that takes in a non-empty array of distict intergers and an interger representing a target sum. If any two numbers in the input array sum up to the target sum,the function should return them in an array, in any order.
